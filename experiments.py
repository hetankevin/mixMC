...
@memoize
def test_baseline(n, L, tau, t_len, n_samples, f=None, jumble=None, seed=None):
...
def test_methods_with_baseline(*args, **kwargs):
    baseline = test_baseline(*args, **kwargs)
...
def test_lastfm(n, L, tau, t_len, users, seed=None):
    ...
    mixture_dt = dt.em_learn(n, L, trails_dt_train, max_iter=1000)
    ...
    mixture_ct_kausik = ct.kausik_learn(n, L, trails_dt_kausik, tau, mle_max_iter=100)
    ...
    mixture_ct_em_continuous = ct.continuous_em_learn(n, L, trails_ct_train, max_iter=100)
